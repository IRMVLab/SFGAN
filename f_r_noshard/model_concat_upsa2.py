...
def Discriminator(point_cloud, flow, is_training, bn_decay=None):
    ...
    with tf.variable_scope('dis', reuse=tf.AUTO_REUSE) as scope_1:
        with tf.variable_scope('sa1', reuse=tf.AUTO_REUSE) as scope_2:
            #Layer1
            l1_xyz_fake, l1_points_fake, l1_indices_fake = pointnet_sa_module(l0_xyz_fake, l0_points_fake, npoint=1024, radius=RADIUS1, nsample=16, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1_1')

            #Layer2
            l2_xyz_fake, l2_points_fake, l2_indices_fake = pointnet_sa_module(l1_xyz_fake, l1_points_fake, npoint=256, radius=RADIUS2, nsample=16, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2_1')

            # scope_2.reuse_variables()

            #Layer1
            l1_xyz_real, l1_points_real, l1_indices_real = pointnet_sa_module(l0_xyz_real, l0_points_real, npoint=1024, radius=RADIUS1, nsample=16, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1_2')

            #Layer2
            l2_xyz_real, l2_points_real, l2_indices_real = pointnet_sa_module(l1_xyz_real, l1_points_real, npoint=256, radius=RADIUS2, nsample=16, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2_2')

            # scope_2.reuse_variables()

            #Layer1
            l1_xyz_f1, l1_points_f1, l1_indices_f1 = pointnet_sa_module(l0_xyz_f1, l0_points_f1, npoint=1024, radius=RADIUS1, nsample=16, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1_3')

            #Layer2
            l2_xyz_f1, l2_points_f1, l2_indices_f1 = pointnet_sa_module(l1_xyz_f1, l1_points_f1, npoint=256, radius=RADIUS2, nsample=16, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2_3')
