...
def Discriminator(point_cloud, flow, is_training, bn_decay=None):
    ...
    l0_points_f1 = point_cloud[:, :num_point, 3:]
    l0_xyz_f2 = point_cloud[:, num_point:, 0:3]
    l0_points_f2 = l0_points_f1
    pc2_2 = point_cloud[:, num_point:, 3:]
    ...
    with tf.variable_scope('dis', reuse=tf.AUTO_REUSE) as scope_1:
        with tf.variable_scope('sa1', reuse=tf.AUTO_REUSE) as scope_2:
            ...
            #Layer1
            l1_xyz_f2_2, l1_points_f2_2, l1_indices_f2_2 = pointnet_sa_module(pc2_2, l0_points_f1, npoint=1024, radius=RADIUS1, nsample=16, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')

            #Layer2
            l2_xyz_f2_2, l2_points_f2_2, l2_indices_f2_2 = pointnet_sa_module(l1_xyz_f2_2, l1_points_f2_2, npoint=256, radius=RADIUS2, nsample=16, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
        with tf.variable_scope('sa3', reuse=tf.AUTO_REUSE) as scope_4:
            _, l2_points_f1_fake = flow_embedding_module(l2_xyz_real, l2_xyz_fake, l2_points_f1, l2_points_fake, radius=10, nsample=64, mlp=[128,128,128], is_training=is_training, bn_decay=bn_decay, bn=True, scope='flow_embedding', pooling='max', knn=True, corr_func='concat')
            scope_4.reuse_variables()
            _, l2_points_f1_real = flow_embedding_module(l2_xyz_real, l2_xyz_f2_2, l2_points_f2_2, l2_points_real, radius=10, nsample=64, mlp=[128,128,128], is_training=is_training, bn_decay=bn_decay, bn=True, scope='flow_embedding', pooling='max', knn=True, corr_func='concat')
        ...
        with tf.variable_scope('sa2', reuse=tf.AUTO_REUSE) as scope_3:
            ...
            #Layer3
            l3_xyz_real, l3_points_real, l3_indices_real = pointnet_sa_module(l2_xyz_f2_2, l2_points_f1_real, npoint=32, radius=RADIUS3, nsample=8, mlp=[128,128,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='d_layer3')
            #end_points['l1_indices'] = l3_indices_fake
